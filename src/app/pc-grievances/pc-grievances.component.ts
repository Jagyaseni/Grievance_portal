...
@Component({
  selector: 'app-pc-grievances',
  templateUrl: './pc-grievances.component.html',
  styleUrls: ['./pc-grievances.component.scss']
})
export class PcGrievancesComponent implements OnInit {
