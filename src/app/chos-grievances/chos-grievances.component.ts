...
@Component({
  selector: 'app-chos-grievances',
  templateUrl: './chos-grievances.component.html',
  styleUrls: ['./chos-grievances.component.scss']
})
export class ChosGrievancesComponent implements OnInit {
  grievances = [
    {
  ...
  ngOnInit(): void {
    this.grievanceService.getAllGrievances({ status: 'CLOSE' }).subscribe(data => {
      console.log(data);
    });
  }
